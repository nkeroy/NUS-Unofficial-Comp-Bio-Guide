...
- [Tips to Studying Comp Bio as a Major (in NUS)](https://github.com/HayashiEsme/NUS-Unofficial-Comp-Bio-Guide#tips-to-studying-comp-bio-as-a-major-in-nus)
   - [Choosing Modules](https://github.com/HayashiEsme/NUS-Unofficial-Comp-Bio-Guide#choosing-modules)
   - [Hidden Prerequisites](https://github.com/HayashiEsme/NUS-Unofficial-Comp-Bio-Guide#hidden-prerequisites)
   - [Finding Likeminded Friends](https://github.com/HayashiEsme/NUS-Unofficial-Comp-Bio-Guide#finding-likeminded-friends) 

- [What do I do if I want to get started early?](https://github.com/HayashiEsme/NUS-Unofficial-Comp-Bio-Guide#what-do-i-do-if-i-want-to-get-started-early)
...
Computational Biology is all about being able to handle the high outputs of genomic data that've started to pour in as a result of being able to quickly sequence genetic data (NGS or Next Generation Sequencing) We as Comp Bio kids are meant to be equipped with the Maths (Statistical) and Computer Science (mainly algorithms - but please look at others) skills that will help process the data for Biologists (or yourself). 

In NUS, you will be given an incredibly demanding foundation in all 3 fields - Biology, Maths(/Stats) and Computer Science. This is unlike a lot of other colleges that may cut down the demands to allow for a lower workload. This degree is unapologetically a strong foundational study in all 3. Take that word of caution (or exciting marketing speech) seriously. This degree is not for the feint-hearted.
...
I just said something very important there. 
...
### Bonus Section for if Data Science/Software Engineering in AI is what you'd like

Communication modules can be very vital to making or breaking a career. You should be aware that CS and Data Science tend to have a very diverse workforce and so being limited to Singlish (or just standard English) can leave you disadvantaged. I would suggest using your GE Modules as an excuse to take some communication classes (on top of the graduation requirement SP1541)

A nice one I like that is pretty fun is GET1047 - Art and Identity (or anything that A/P Greg Petersen teaches - I hear he switches between a cycle of modules so do look for those. They're wonderful). 
...
SoC is particularly helpful because they will help by running workshops that teach you the basics to Java, C++ and the command line. Join up, join hackerthons,join NUS Hackers. I hang out there and will be happy to help out if you need. 

Keep a look out for things like this if you're in NS and waiting for college to start.

Doing the iBLOCS in CS1010X is also an incredibly great way to lower your workload when in NUS. This will let you take a module before you start college (either because of NS or because of a gap year) and only doing one or two subjects will help you ease into college life as well as give you an infinitely better foundation than doing it with other subjects. 

This may also be an ideal way to make friends as you'll be taking classes with equally motivated students.
...
https://www.dropbox.com/sh/w589r2hmoqpf6qs/AAAyxtF_x7JIJhh9R5QXdM96a?dl=0

NUS Box Link to Study Materials: 
https://app.box.com/v/socrepository
